...
>
    <div class="space-y-4">
        ...
        @include('admin.announcements._category-fields', ['storedCategory' => 'Parish Life'])
        ...
        <div x-data="{ dateFrom: '{{ old('date_from') }}', dateTo: '{{ old('date_to') }}' }">
        ...
        <div class="flex items-center gap-3 pt-4 border-t">
            ...
            <input type="checkbox" name="is_featured" id="is_featured" value="1" {{ old('is_featured') ? 'checked' : '' }}
                class="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary">
            <label for="is_featured" class="text-sm font-bold text-primary cursor-pointer">Feature on homepage</label>
        </div>
