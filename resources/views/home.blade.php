...
<x-slot name="meta">
    ...
    <style>
        ...
        .eyebrow{font-size:12px;font-weight:600;letter-spacing:.32em;text-transform:uppercase;color:var(--gold);}
        .divider-ornament{display:flex;align-items:center;gap:12px;justify-content:center;}
        .divider-ornament::before,.divider-ornament::after{content:'';height:1px;width:48px;background:linear-gradient(90deg,transparent,rgba(245,197,24,.5));}
        .divider-ornament::after{background:linear-gradient(90deg,rgba(245,197,24,.5),transparent);}
        .gold-btn{background:linear-gradient(135deg,#FFD740 0%,#F5C518 55%,#E0A800 100%);color:var(--blue-deep);box-shadow:0 4px 20px rgba(245,197,24,.4),0 1px 0 rgba(255,255,255,.35) inset;transition:all .25s ease;font-weight:700;}
        .gold-btn:hover{box-shadow:0 8px 32px rgba(245,197,24,.55),0 1px 0 rgba(255,255,255,.35) inset;transform:translateY(-2px);}
        .ghost-btn{border:1.5px solid rgba(245,197,24,.5);color:rgba(255,255,255,.9);background:rgba(255,255,255,.05);backdrop-filter:blur(6px);transition:all .25s ease;}
        .ghost-btn:hover{border-color:var(--gold-light);color:var(--gold-light);background:rgba(245,197,24,.1);transform:translateY(-2px);}
        .card-sacred{background:#fff;border:1px solid rgba(26,64,128,.12);border-radius:20px;transition:all .3s ease;}
        .card-sacred:hover{border-color:rgba(245,197,24,.55);box-shadow:0 10px 40px rgba(13,42,82,.12);transform:translateY(-3px);}
        .section-ruled{border-top:1px solid rgba(26,64,128,.08);}
        .hero-overlay{background:linear-gradient(180deg,rgba(8,20,45,.68) 0%,rgba(10,25,55,.58) 40%,rgba(8,20,45,.8) 72%,rgba(247,249,255,1) 100%);}
        .hero-title-accent{background:linear-gradient(90deg,#FFD740 0%,#fff 40%,#FFD740 60%,#F5C518 100%);background-size:200% auto;-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent;}
        .hero-badge{display:inline-flex;align-items:center;gap:8px;padding:6px 18px;border-radius:100px;border:1px solid rgba(245,197,24,.35);background:rgba(245,197,24,.08);backdrop-filter:blur(8px);}
        .mass-card{background:linear-gradient(135deg,#fff 0%,#F0F5FF 100%);}
        .cross-container{position:relative;width:40px;height:52px;display:flex;align-items:flex-end;justify-content:center;}
        .cross-ray{position:absolute;background:var(--gold);width:1px;opacity:.4;transform-origin:bottom center;}
        ...
        .card-event{background:#fff;border:1px solid rgba(26,64,128,.1);border-radius:20px;transition:all .4s cubic-bezier(.16,1,.3,1);display:flex;flex-direction:column;text-align:center;position:relative;}
        .card-event:hover{border-color:var(--gold);box-shadow:0 20px 50px rgba(13,42,82,.12);transform:translateY(-5px);}
        ...
        .reading-line{margin-bottom:.2rem;}
        .reading-line--blank{height:.7rem;}
        .reading-line--response{display:grid;grid-template-columns:2.1rem 1fr;column-gap:.45rem;align-items:start;margin:.35rem 0;}
        .reading-marker{font-weight:800;color:rgba(13,42,82,.8);}
        .reading-response{font-weight:800;color:rgba(13,42,82,.85);}
        .reading-line--or{margin:.45rem 0 .15rem;}

        @media (max-width:640px){
            .hero-badge{padding:5px 14px;}
            .hero-badge span:last-child{font-size:11px;letter-spacing:.22em;}
            .hero-cta-wrap{flex-direction:column!important;align-items:stretch!important;gap:10px!important;}
            .hero-cta-wrap a{width:100%!important;justify-content:center!important;}
            .hero-stats-strip{gap:20px!important;}
            .hero-stats-strip .stat-val{font-size:1.35rem!important;}
            .next-mass-inner{flex-direction:column!important;align-items:center!important;text-align:center!important;padding:28px 20px!important;gap:16px!important;}
            .next-mass-inner .eyebrow-row{justify-content:center!important;}
            .office-cols{grid-template-columns:1fr!important;border-radius:14px!important;}
            .office-col-border{border-left:none!important;border-top:1px solid rgba(26,64,128,.07)!important;}
            ...
            .ann-header-spacer,.ann-nav-btns{display:none!important;}
            ...
            .intention-btns{flex-direction:column!important;align-items:stretch!important;gap:10px!important;}
        ...
        @media (min-width:641px) and (max-width:1023px){
            ...
            .services-grid{grid-template-columns:repeat(3,1fr)!important;gap:12px!important;}
