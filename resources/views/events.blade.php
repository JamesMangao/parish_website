            ...
            @empty
                <div class="text-center py-24 bg-card rounded-[3rem] border border-dashed border-primary/20 shadow-inner">
                    <div class="h-20 w-20 bg-primary/5 rounded-full flex items-center justify-center mx-auto mb-6 text-primary/30">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10"/><path d="m14 14-4 4"/><path d="m10 14 4 4"/></svg>
                    </div>
                    <h3 class="text-xl font-black text-primary uppercase tracking-tighter italic font-heading mb-2">No Upcoming Events</h3>
                    <p class="text-muted-foreground italic text-sm max-w-xs mx-auto">We are currently planning more community activities. Please check back soon or follow our announcements!</p>
                </div>
            @endforelse
        </div>
    </div>
